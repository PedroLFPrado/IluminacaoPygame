...
def init():
    ...
    glClearColor(0.8, 0.9, 1.0, 1.0)  # céu claro por baixo da névoa
    ...
    glFogi(GL_FOG_MODE, fog_mode)       # GL_LINEAR / GL_EXP / GL_EXP2
...
def main():
    ...
    pygame.display.set_caption("Fog (1=LINEAR, 2=EXP, 3=EXP2, [/] densidade)")
    init()
